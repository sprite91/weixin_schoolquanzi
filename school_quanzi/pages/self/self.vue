			...
			<view class="group" @click="toUserInfo">
				<view class="userinfo">
					<view class="pic">
						...
						<image v-else src="https://mp-06b56c9b-0f1c-45e0-add5-af96eacae8fb.cdn.bspapp.com/cloudstorage/images/user-default.jpg" mode="aspectFill"></image>
					</view>
	...
	export default {
		...
		methods:{
			...
			async getTotal(){
				...
				let artCount = await db.collection("quanzi_article").where(`user_id ==$cloudEnv_uid`)
				.count();
