<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="_title" label="标题" required>
        <uni-easyinput placeholder="请输入标题" v-model="formData._title"></uni-easyinput>
      </uni-forms-item>
      ...
      <uni-forms-item name="navid" label="分类">
        <uni-data-picker v-model="formData.navid" collection="quanzi_study_nav" field="_id as value, classname as text"></uni-data-picker>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/study_content.js';
let editor = null
  import E from 'wangeditor'
  const db = uniCloud.database();
  const dbCmd = db.command;
  const dbCollectionName = 'study_content';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("_title,state,navid,orderid,content,author,article_status,view_count,avatar,publish_date,is_essence,is_essence").get().then((res) => {
