  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("avatar,avatar_file,comment,dcloud_appid,last_login_date,last_login_ip,mobile,mobile_confirmed,nickname,role,tags,score,status,token,username,wx_unionid,qq_unionid,identities").get().then((res) => {
